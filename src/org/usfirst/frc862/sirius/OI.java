...
import org.usfirst.frc862.sirius.commands.ShooterSetAngle;
...
public class OI {
    ...
    public JoystickButton shootBoulderNow;
    public JoystickButton raiseCollectorNow;
    public JoystickButton lowerCollectorNow;
    public JoystickButton spinUpNow;
    public JoystickButton stopFlyWheelsNow;
    ...
    public OI() {
        ...
        coPilot = new Joystick(0);
        
        stopFlyWheelsNow = new JoystickButton(coPilot, 1);
        stopFlyWheelsNow.whenPressed(new SpinUpFlyWheels(0));
        spinUpNow = new JoystickButton(coPilot, 1);
        spinUpNow.whenPressed(new SpinUpFlyWheels(1));
        lowerCollectorNow = new JoystickButton(coPilot, 1);
        lowerCollectorNow.whenPressed(new LowerCollector());
        raiseCollectorNow = new JoystickButton(coPilot, 1);
        raiseCollectorNow.whenPressed(new RaiseCollector());
        shootBoulderNow = new JoystickButton(coPilot, 1);
        shootBoulderNow.whenPressed(new ShootBoulder());
        ...
        SmartDashboard.putData("Manual Pivot", new ManualPivot());
        SmartDashboard.putData("Raise Collector", new RaiseCollector());
        SmartDashboard.putData("Shoot Boulder", new ShootBoulder());
        SmartDashboard.putData("Shooter Set Angle: Hard Stop", new ShooterSetAngle(12));
        SmartDashboard.putData("Shooter Set Angle: Load Boulder", new ShooterSetAngle(38));
        SmartDashboard.putData("Shooter Set Angle: Long Shot", new ShooterSetAngle(45));
    ...
    public double getLeft() {
        return -coPilot.getRawAxis(1);
    }
    
    public double getRight() {
        return -coPilot.getRawAxis(3);
    }
}
