...
public class OI {
    ...
    public OI() {
        ...
        rotateRightButton = new JoystickButton(leftJoystick, 6);
        rotateRightButton.whileHeld(new RotatetoDeltaAngle(-20));
        rotateLeftButton = new JoystickButton(leftJoystick, 5);
        ...
        shootdaBoulder = new JoystickButton(gamepad, 6);
        ...
        downShiftButton = new JoystickButton(gamepad, 9);
        downShiftButton.whenPressed(new DownShift());
        upShiftButton = new JoystickButton(gamepad, 10);
        upShiftButton.whenPressed(new UpShift());
