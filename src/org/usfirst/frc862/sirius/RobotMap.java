...
public final class RobotMap {
    ...
    public static AnalogInput driveTrainFrontAmbientLightSensor;
    public static AnalogInput driveTrainRearAmbientLightSensor;
    public static PowerDistributionPanel infrastructurePowerDistributionPanel;
    public static Compressor infrastructurekompressor;
    ...
    public static void init() {
        ...
        driveTrainFrontAmbientLightSensor = new AnalogInput(0);
        LiveWindow.addSensor("Drive Train", "Front Ambient Light Sensor", driveTrainFrontAmbientLightSensor);
        
        driveTrainRearAmbientLightSensor = new AnalogInput(1);
        LiveWindow.addSensor("Drive Train", "Rear Ambient Light Sensor", driveTrainRearAmbientLightSensor);
        
        infrastructurePowerDistributionPanel = new PowerDistributionPanel(10);
        LiveWindow.addSensor("Infrastructure", "PowerDistributionPanel", infrastructurePowerDistributionPanel);
        
        infrastructurekompressor = new Compressor(11);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        pivotAngleMotor.setInverted(true);
